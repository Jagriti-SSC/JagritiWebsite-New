  ...
  return (
    <div style={{overflow:"hidden"}} className="flex flex-col md:mt-44 relative md: w-[130vw]">
      ...
      <Marquee style={{overflow:"hidden"}} direction="right" gradient={false} speed="35" className="py-5 w-full mx-auto relative" >
        ...
        <img src={img10} className="h-40  mx-[10px] box-shadow" alt="Jagriti Image"></img>
        ...
        <img src={img21} className="h-40 mx-[10px] box-shadow" alt="Jagriti Image"></img>
      ...
      <Marquee style={{overflow:"hidden"}} gradient={false} speed="45" className="py-5 mx-auto w-full relative" >
        ...
        <img src={img28} className="h-40  mx-[10px] box-shadow" alt="Jagriti Image"></img>
        <img src={img23} className="h-40  mx-[10px] box-shadow" alt="Jagriti Image"></img>
        <img src={img22} className="h-40  mx-[10px] box-shadow" alt="Jagriti Image"></img>
        <img src={img24} className="h-40  mx-[10px] box-shadow" alt="Jagriti Image"></img>
        <img src={img29} className="h-40  mx-[10px] box-shadow" alt="Jagriti Image"></img>
        <img src={img26} className="h-40  mx-[10px] box-shadow" alt="Jagriti Image"></img>
        <img src={img30} className="h-40  mx-[10px] box-shadow" alt="Jagriti Image"></img>
      ...
      <Marquee style={{overflow:"hidden"}} gradient={false} direction="right" speed="55" className="py-5 mx-auto w-full relative" >
        ...
        <img src={img27} className="h-40  mx-[10px] box-shadow" alt="Jagriti Image"></img>
        <img src={img25} className="h-40  mx-[10px] box-shadow" alt="Jagriti Image"></img>
