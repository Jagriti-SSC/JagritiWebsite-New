        ...
        <div className={style.event_form_div}>
          <form className={style.event_form} onSubmit={handleSubmit} action="#">
            <div className="bg-white shadow-[0px_10px_30px_rgba(102,_106,_245,_0.13)] w-[903px] h-[250px] rounded-3xl info-div-1">
              ...
              <div
                className="absolute top-[250px] left-[60px] leading-[26.4px] whitespace-pre-wrap text-black "
              ...
              <div
                className="absolute top-[250px] left-[562px] leading-[26.4px] whitespace-pre-wrap text-black info-1"
                style={{ fontWeight: "900" }}
              >
              ...
              <div className="absolute top-[250px] left-[157px] leading-[26.4px] text-black ">
              ...
              <div className="absolute top-[250px] left-[686px] leading-[26.4px] text-black info-2">
                <p className="m-0">
