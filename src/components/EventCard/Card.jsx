...
const Card = ({data,open,index}) => {
  ...
  return (
    <motion.div onClick={open} className= {` md:min-h-[380px] md:w-[350px] ss:h-[350px] ss:w-[300px] sm:h-[400px] sm:w-[400px]  h-[260px] w-[200px]  cursor-pointer mx-auto rounded-tl-[25px] rounded-br-[25px] flex flex-col justify-evenly items-center border-black border gap-3 ${style}`} >
