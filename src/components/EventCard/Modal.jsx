...
const Modal = ({ data, close }) => {
  ...
  return (
    ...
    <motion.h1 className=" md:text-3xl xxs:text-2xl text-center text-lg text-blue font-bold md:mt-0 ">{data.eventName}</motion.h1>
...
<motion.h2 className=' text-xl sm:text-3xl ss:text-2xl'>Contact</motion.h2>
 <motion.div className=' text-blue xs:text-lg ss:text-xl text-sm mb-6'>
      ...
      {isAboveLargeScreen ? (
        <>
          ...
          >
            ...
            <motion.div className="md:mb-[37px] mb-[20px] mt-auto mx-auto">
              <Button
                text={registration ? `Register` : `Registeration Closed `}
                path={registration ? data.link : ""}
        ...
        <>
          <motion.div className=" mx-6" variants={imageVariants}>
            ...
            <motion.p className="text-blue xs:text-lg  text-[12px]  mb-6">
              {data.timeline}
            </motion.p>
      ...
      <motion.div className="md:mb-[37px] mb-[20px] mt-auto  mx-auto md:hidden">
        <Button
          text={registration ? `Register` : `Registration Closed`}
          path={registration ? data.link : ""}
          disabled={!registration}
        ></Button>
      </motion.div>
