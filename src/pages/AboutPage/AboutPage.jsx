...
import ClubCard from "../../components/card_aboutPage/ClubCard";
const AboutPage = () => {
  return (
    <>
      <div className="text-center my-10 mx-5">
        <img className="mx-auto" src="/assets/Jagriti_big_logo.png" alt="" />
        <h2 className="text-5xl text-blue font-Montserrat tracking-tight font-bold">
          JAGRITI
        </h2>
      ...
      <div className="text-center my-10 mx-5">
        <img className="w-[300px] mx-auto" src="/assets/SSC_logo.png" alt="" />
        <h2 className="text-blue font-Montserrat text-5xl tracking-tight font-bold">
      ...
      <div className="lg:flex m-5 p-5 gap-5 justify-center">
        <div className="my-5">
          <ClubCard
